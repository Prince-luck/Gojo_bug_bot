...
senddocu(buffer)
    ...
    case 'autostatusview':{
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://telegra.ph/file/4ee9c6d60d6d8c48a63e1.jpg',
        ...
        let txxt= `*U^I^U ♡* *Konichiwa ${pushname} Senpai, I'm WOLF Created by Team ALPHA WOLF*`;

        replygcxeon(txxt,{ image: { url: "https://graph.org/file/eb3821e4d2b0a54dd7ea6.jpg" }, caption: txxt}, { quoted: m });
        ...
        break;
                ...
                case 'truth':
                 ...
                 "do you play free fire codm PUBG blood strike, if you then send ur id number"
             ]
...
"eat 2 tablespoons of rice without any side dishes, if it's dragging you can drink",
  ...
  return dare[Math.floor(Math.random() * dare.length)];

}

  const randomdare = getRandomdare();
  replygcxeon(randomdare)
                   break;
                case 'insult': {
 if (!m.isGroup) return replygcxeon (mess.group)
 const insults = [
...
break;
 ...
 const flirtLines = [
  ...
  "Do you have a name, or can I call you mine?",
  "Do you have a name, or can I call you mine?",
  "The person reading this is also and was probably a joke,"
];
...
break
            ...
            case 'alive':
            case '?':
                let xeonmenuoh = `Hello senpai ${pushname}
╰┈➤ ${xeonytimewisher} 😄
©wolf
${readmore}
└─ 𝘽𝙊𝙏 𝙄𝙉𝙁𝙊 
